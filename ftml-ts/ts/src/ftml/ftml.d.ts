...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_34842: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_34844: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_24498: (a: number, b: number, c: number) => number;
    readonly __wasm_bindgen_func_elem_28814: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_10464: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_28543: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_28814_4: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_19896: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_28542: (a: number, b: number) => void;
    readonly __wasm_bindgen_func_elem_28813: (a: number, b: number) => void;
