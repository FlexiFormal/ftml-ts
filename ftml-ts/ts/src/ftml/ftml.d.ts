...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_34709: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_34711: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_20310: (a: number, b: number, c: number) => number;
    readonly __wasm_bindgen_func_elem_28817: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_10386: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_28564: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_28817_4: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_25177: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_28563: (a: number, b: number) => void;
    readonly __wasm_bindgen_func_elem_28816: (a: number, b: number) => void;
